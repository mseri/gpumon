...
(* OASIS_START *)
(* DO NOT EDIT (digest: d763be5204b3639400ee58203820dd33) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("threads", None);
                           FindlibPackage ("stdext", None);
                           FindlibPackage ("xapi-rrdd-plugin", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_digest = Some "\132\"\022\165\021\235\216\213\253A\230\014!qR\179";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
